...
<html lang = "en">
    <head>
        ...
        <link rel = "stylesheet" href = "updateAccountStyle.css">
    ...
    <body>
        ...
        <form action = "updateDatabase.php" method = "POST" enctype="multipart/form-data" autocomplete = "off">
            <div class = "infoContainer">
                <div class = "imageContainer">
                    <img class = "userImage" width = 250px; src = "<?php echo $_SESSION['imagePath'] ?>"><br>
                    <input type = "file" name = "uploadImage" class = "uploadImage">
                </div>
                <div class = "detailContainer">
                    <table>
                        <tr>
                            <td colspan = "2" class = "detailTitle"> User Information </td>
                        </tr>
                        <tr>
                            <td class = "tableLabel"><label for = "fullName" class = "detailLabel"> Full Name </td>
                            <td><input type = "text" name = "fullName" class = "infoInput" value = "<?php echo $_SESSION['fullName'] ?>" required></label></td>
                        </tr>
                        <tr>
                            <td class = "tableLabel"><label for = "address" class = "detailLabel"> Address </td>
                            <td><input type = "text" name = "address" class = "infoInput" value = "<?php echo $_SESSION['address'] ?>" required></label></td>
                        </tr>
                        <tr>
                            <td class = "tableLabel"><label for = "contactNumber" class = "detailLabel"> Contact Number </td>
                            <td><input type = "number" name = "contactNumber" class = "infoInput" value = "<?php echo $_SESSION['contactNumber'] ?>" required></label></td>
                        </tr>
                        <tr>
                            <td class = "tableLabel"><label for = "email" class = "detailLabel"> Email </td>
                            <td><input type = "email" name = "email" class = "infoInput" value = "<?php echo $_SESSION['email'] ?>" required></label></td>
                        </tr>
                    </table>
                    <br>
                    <table>
                        <tr>
                            <td class = "tableLabel"><label for = "currentPassword" class = "detailLabel"> Enter Password </td>
